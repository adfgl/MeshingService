public static class Interpolation
{
        ...
        double x, double y)
    {
        ...
        double denom = GeometryHelper.Cross(e0x, e0y, e1x, e1y);
        ...
        double w1 = GeometryHelper.Cross(px, py, e1x, e1y) / denom; // weight at v1
        double w2 = GeometryHelper.Cross(e0x, e0y, px, py) / denom; // weight at v2
        double w0 = 1.0 - w1 - w2;
